...
const PROPAGATION = {
  ...
  // Cross-paired: wb-r2-m1 loser goes to lb-r2-m2 (not m1) to prevent rematches
  'wb-r2-m1': { winTo: ['wb-r3-m1', 1], loseTo: ['lb-r2-m2', 2] },
  'wb-r2-m2': { winTo: ['wb-r3-m1', 2], loseTo: ['lb-r2-m1', 2] },
